...
const memoryexceededqcoAPI = axios.create({
  baseURL: "https://memory-exceeded-qco-93458.botics.co",
  headers: { Accept: "application/json", "Content-Type": "application/json" }
})
function api_docs_schema_retrieve(payload) {
  return memoryexceededqcoAPI.get(`/api-docs/schema/`, {
...
function api_v1_signup_create(payload) {
  return memoryexceededqcoAPI.post(`/api/v1/signup/`, payload.data)
}
function rest_auth_login_create(payload) {
  return memoryexceededqcoAPI.post(`/rest-auth/login/`, payload.data)
}
function rest_auth_logout_retrieve(payload) {
  return memoryexceededqcoAPI.get(`/rest-auth/logout/`)
}
function rest_auth_logout_create(payload) {
  return memoryexceededqcoAPI.post(`/rest-auth/logout/`)
}
function rest_auth_password_change_create(payload) {
  return memoryexceededqcoAPI.post(`/rest-auth/password/change/`, payload.data)
}
function rest_auth_password_reset_create(payload) {
  return memoryexceededqcoAPI.post(`/rest-auth/password/reset/`, payload.data)
}
function rest_auth_password_reset_confirm_create(payload) {
  return memoryexceededqcoAPI.post(
    `/rest-auth/password/reset/confirm/`,
    payload.data
  )
}
function rest_auth_registration_create(payload) {
  return memoryexceededqcoAPI.post(`/rest-auth/registration/`, payload.data)
}
...
function rest_auth_user_retrieve(payload) {
  return memoryexceededqcoAPI.get(`/rest-auth/user/`)
}
function rest_auth_user_update(payload) {
  return memoryexceededqcoAPI.put(`/rest-auth/user/`, payload.data)
}
function rest_auth_user_partial_update(payload) {
  return memoryexceededqcoAPI.patch(`/rest-auth/user/`, payload.data)
}
