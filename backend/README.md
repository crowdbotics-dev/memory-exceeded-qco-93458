...
## Project Structure
    ...
    ├── memory_exceeded_qco_93458  # Django project configurations
...
1. Clone this repo and `cd memory_exceeded_qco_93458`
...
2. Clone this repo and `cd memory_exceeded_qco_93458`
